...
public record WheresTheBoneView(
        ...
        String discussionSkipRequesterId,
        int discussionSkipAgreeCount,
        int discussionSkipResponseCount,
        int discussionSkipRequiredAgreeCount,
        Boolean myDiscussionSkipResponse,
